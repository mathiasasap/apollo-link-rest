(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(
        ...
        require('graphql-anywhere/lib/async'),
        require('qs'),
      )
    ...
    : factory(
        (global['apollo-link-rest'] = {}),
        global.apolloClient.core,
        global.apolloClient.utilities,
        global.graphqlAnywhere.async,
        global.qs,
      );
  ...
  var convertObjectKeys = function(object, __converter, keypath) {
    ...
    if (
      (global.FileList && object instanceof FileList) ||
    ...
    if (Array.isArray(object)) {
      return object.map(function(o, index) {
        return convertObjectKeys(
          o,
          converter,
          __spreadArrays(keypath, [String(index)]),
        );
      });
    }
   ...
   */
  var overrideHeadersMergePolicy = function(
    linkHeaders,
    headersToOverride,
    requestHeaders,
  ) {
    ...
    return __awaiter(void 0, void 0, void 0, function() {
      ...
      return __generator(this, function(_c) {
        switch (_c.label) {
          case 0:
            ...
            copyExportVariables = function(result) {
              if (result instanceof Array) {
                ...
                exportVariablesByNode.set(
                  result,
                  __assign({}, exportVariables),
                );
              }
              return result;
            };
            ...
            (credentials = context.credentials),
              ...
              (responseTransformer = context.responseTransformer);
            ...
            if (!pathBuilder) {
              if (!path.includes(':')) {
                ...
                pathBuilder = function(_a) {
                  ...
                  var legacyArgs = __assign(
                    __assign({}, args),
                    exportVariables,
                  );
                  var pathWithParams = Object.keys(legacyArgs).reduce(function(
                    acc,
                    e,
                  ) {
            ...
            (_b = directives.rest),
              ...
              (bodySerializer = _b.bodySerializer);
            if (!method) {
              method = 'GET';
            }
            if (!bodyKey) {
                ...
                if (!maybeBody_1) {
                  throw new Error(
                    '[GraphQL ' +
                      ...
                      ' ' +
                      operationType +
                      ' using a REST call without a body]. No `' +
                      bodyKey +
                      '` was detected. Pass bodyKey, or bodyBuilder to the @rest() directive to resolve this.',
                  );
                }
                ...
                if (!serializers.hasOwnProperty(bodySerializer)) {
                  throw new Error(
                    '"bodySerializer" must correspond to configured serializer. ' +
                      ('Please make sure to specify a serializer called ' +
                        bodySerializer +
                        ' in the "bodySerializers" property of the RestLink.'),
                  );
                }
          ...
          case 9:
            transformer =
              endpointOption.responseTransformer || responseTransformer;
  ...
  var RestLink = /** @class */ (function(_super) {
    ...
    function RestLink(_a) {
      ...
      _this.serializers = __assign(
        ((_b = {}),
        (_b[DEFAULT_SERIALIZER_KEY] =
          defaultSerializer || DEFAULT_JSON_SERIALIZER),
        _b),
        bodySerializers || {},
      );
    ...
    RestLink.prototype.removeRestSetsFromDocument = function(query) {
      ...
      var docClone = utilities.removeDirectivesFromDocument(
    ...
    RestLink.prototype.request = function(operation, forward) {
      ...
      } else obs = core.Observable.of({ data: {} });
